...
export const REQUIRED_ENDPOINTS = {
  ...
  [API_ENDPOINT_EMPLOYEE_LEAVE_REQUEST]: [HTTP_METHOD_GET],
  [API_ENDPOINT_LEAVES]: [HTTP_METHOD_GET, HTTP_METHOD_POST],
  [API_ENDPOINT_EMPLOYEE_LEAVE_BALANCE]: [HTTP_METHOD_GET],
